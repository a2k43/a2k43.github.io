...
try {
	...
	switch ($_GET['view']) {
		...
		case 'wallet':
			...
			if(isset($_GET['withdraw_succeed']) && isset($_SESSION['wallet_withdraw_amount'])) {
				/* assign variables */
				$smarty->assign('wallet_withdraw_amount', $_SESSION['wallet_withdraw_amount']);
				/* unset session */
				unset($_SESSION['wallet_withdraw_amount']);
			}
