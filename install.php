...
(12, 'vi_vn', 'Ti&#7871;ng Vi&#7879;t', 'flags/vi_vn.png', 'LTR', '0', '1');
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="fs-form-wrap" id="fs-form-wrap">
                ...
                <div class="fs-title">
                    <h1>Sngine Installer (<?php echo SYS_VER ?>) VietHoa boi Nam.Name.Vn</h1>
                </div>
                    ...
                    <ol class="fs-fields">
                        ...
                        <li>
                            <p class="fs-field-label fs-anim-upper">
                                Welcome to <strong>Sngine</strong> installation process! Just fill in the information below and create your own social website or online community.<br />
                            </p>
                        </li>

                        <li>
                            <label class="fs-field-label fs-anim-upper" for="purchase_code" data-info="The purchase code of Sngine">Purchase Code</label>
                            <input class="fs-anim-lower" id="purchase_code" name="purchase_code" type="text" value="Nam.Name.Vn" placeholder="Nam.Name.Vn" required/>
                        </li>
