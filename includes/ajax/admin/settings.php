	...
	switch ($_GET['edit']) {
		...
		case 'features_settings':
			...
			$db->query(sprintf("UPDATE system_options SET 
						...
						cookie_consent_enabled = %s ", secure($_POST['contact_enabled']), secure($_POST['directory_enabled']), secure($_POST['pages_enabled']), secure($_POST['groups_enabled']), secure($_POST['events_enabled']), secure($_POST['blogs_enabled']), secure($_POST['users_blogs_enabled']), secure($_POST['market_enabled']), secure($_POST['games_enabled']), secure($_POST['daytime_msg_enabled']), secure($_POST['verification_requests']), secure($_POST['profile_notification_enabled']), secure($_POST['browser_notifications_enabled']), secure($_POST['noty_notifications_enabled']), secure($_POST['cookie_consent_enabled']) )) or _error(SQL_ERROR_THROWEN);
			break;
		...
		case 'posts':
			...
			$db->query(sprintf("UPDATE system_options SET 
						...
						yandex_key = %s, 
						default_privacy = %s", secure($_POST['stories_enabled']), secure($_POST['wall_posts_enabled']), secure($_POST['social_share_enabled']), secure($_POST['smart_yt_player']), secure($_POST['polls_enabled']), secure($_POST['geolocation_enabled']), secure($_POST['geolocation_key']), secure($_POST['post_translation_enabled']), secure($_POST['yandex_key']), secure($_POST['default_privacy']) )) or _error(SQL_ERROR_THROWEN);
			break;
